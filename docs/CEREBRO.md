...
- [ ] @eduardo Confirmar o caminho do vault do Obsidian (se houver) dentro da
      pasta compartilhada `smb://192.168.2.1/hackathon`, para Fernando e Maria
      acessarem pelo Obsidian local deles.
